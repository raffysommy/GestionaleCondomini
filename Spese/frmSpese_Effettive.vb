...
Namespace Gestionale_Condomini
    ...
    Public Class frmSpese_Effettive
        Dim str As StringaConnessione = New StringaConnessione
        Private ad As MySqlDataAdapter

        Private Sub frmSpese_Effettive_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
            Dim strConn As String = str.conn
            ad = New MySqlDataAdapter("select * from `Spese_Effettive`", strConn)
            Dim builder As MySqlCommandBuilder = New MySqlCommandBuilder(ad)
            ad.Fill(Me.newDataSet.Spese_Effettive)
            ...
            Dim colData As MyDateTimePickerColumn = New MyDateTimePickerColumn()
            colData.DataPropertyName = "Data"
            colData.HeaderText = "Data"
            colData.Name = "colData"
            dataGridView1.Columns.Add(colData)
            ...
            Dim colOrd_Straord As System.Windows.Forms.DataGridViewCheckBoxColumn = New System.Windows.Forms.DataGridViewCheckBoxColumn()

            colOrd_Straord.DataPropertyName = "Ord_Straord"
            colOrd_Straord.HeaderText = "Ord/Straord"
            colOrd_Straord.Name = "colOrd_Straord"
            dataGridView1.Columns.Add(colOrd_Straord)
            Me.dataGridView1.DataSource = Me.Spese_EffettiveBindingSource
        End Sub
        ...
        Private Sub ToolStripButton1_Click(sender As System.Object, e As System.EventArgs) Handles ToolStripButton1.Click
            If Not Me.Validate() Then
                Return
            End If
            Spese_EffettiveBindingSource.EndEdit()
            ad.Update(Me.newDataSet.Spese_Effettive)
        End Sub

        Private Sub frmSpese_Effettive_FormClosing(sender As System.Object, e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
            e.Cancel = False
        End Sub
        ...
        Private Sub dataGridView1_CellValidating(sender As Object, e As DataGridViewCellValidatingEventArgs) Handles dataGridView1.CellValidating
            ...
            If e.ColumnIndex = 2 Then
                ...
                If (TypeOf value Is DBNull) OrElse String.IsNullOrEmpty(value.ToString()) Then
                    e.Cancel = True
                    row.ErrorText = "Il campo Data e' richiesto"
                    Return
                End If
            End If
            ...
            'If (TypeOf value Is DBNull) OrElse String.IsNullOrEmpty(value.ToString()) Then
            'e.Cancel = True
            'row.ErrorText = "Il campo Ord/Straord e' richiesto"
            'Return
            'End If
            'End If
        End Sub
        ...
        Private Sub bindingNavigatorAddNewItem_Click(sender As System.Object, e As System.EventArgs) Handles BindingNavigatorAddNewItem.Click
            Spese_EffettiveBindingSource.AddNew()
        End Sub
